...
export class DateAgentDTO {
  prmStartDate: string = "";
  prmEndDate: string = "";
  prmIdAgent: number = 0;
}

export class GetAgentHoldPercentRequest {
 StartDate: string = "";
 EndDate: string = "";
 prmIdAgent: number = 0;
}

export class ReportAgentPlayerCountDTO{
    IdAgent: number = 1;
    Agent: string = "";
    IdPlayer: number = 3;
    Player: string = "";
    AccessLocal: number = 5;
    AccessOnline: number = 6;
    GradedWagerLocal: number = 7;
    GradedWagerOnline: number = 8;
    OpenWagerLocal: number = 9;
    OpenWagerOnline: number = 10
}

export class GetAgentHoldPercentResult {
  Agent: string = "";
  StrWagerType: string = "";
  WagerType:  number = 0;
  IdSport: string = "";
...
export class GetWebvsPhone{
  Agent: string = "";
  IdAgent: number = 0;
  PhoneVol: number = 0;
  PhoneCount: number = 0;
  PhonePlayers: number = 0;
  OnlineVol: number = 0;
  OnlineCount: number = 0;
  OnlinePlayers: number = 0;
  CasinoVol: number = 0;
  CasinoCount: number = 0;
  CasinoPlayers: number = 0;
}

export class GetPlayerAccessRequestDTO{
  prmStartDate: string = "";
  prmEndDate: string = "";
  prmIP: string | null = "";
  prmPhoneLine: number | null = 0;
  prmIdAgent: number = 0;
  prmIdPlayer: number = 0;
}

export class GetPlayerAccessResultDTO{
  Agent: string = "";
  Player: string = "";
  IP: string = "";
  StartTime: string = "";
...
export class GetTopPlayerRequestDTO{
  prmStartDate: string = "";
  prmEndDate: string = "";
  prmTopNumber: string = "";
  prmIdSport: string = "";
  prmOrderBy: boolean = false;
  prmIdAgent: number = 0;
}

export class GetTopPlayerResultDTO{
  Player: string = "";
  IdPlayer: number = 0;
  LastWager: string = "";
  Win: number = 0.0;
...
export class PlayerDto {
  ...
  IdProfileLimits: number = 0;
  LineStyle: number = 0;
  MLBLine: string = '';
  NHLLine: string = '';
  OnlineMessage: string[] = new Array();
  Password: string = '';
  PitcherDefault: number = 0;
  UTC: number = 0;

  OnlineWinWager: number = 0;
  OnlinePassword: string = '';
  DuplicatedBetsOnline: boolean = false;
  FreePlayAmount: number = 0;
  Status: string = '';
  OnlineAccess: boolean = false;

  IdOffice: number = 0;
  HoldBetsL: boolean = false;
  Gmt: number = 0;
  ClMaxWager: number = 0;
...
export class PlayerTransferDto {
  ...
  CurrencyDesc: string = '';
  PitcherDefault: number = 0;
  public FreePlay: number = 0;
  public FreePlayOddsLimit: number = 0;
  public FreePlayMaxPayout: number = 0;
  public FreePlayMaxFavorite: number = 0;
  public FreePlayMaxTeams: number = 0;
  public FreePlayAllowDuplicateBets: boolean = false;
  public FreePlayCheckIfficeFilters: boolean = false;
  public FreePlayAllowBothSides: boolean = false;
}

export class PlayerTransactionDTO {
  Id?: number = 0;
  IdPlayer?: number = 0;
  RemoteId?: number = 0;
  Player?: string = '';
...
export class AgentInfoDto {
  ...
  LastWeek: number = 0;
  MakeUp: number = 0;
  LastWeekMakeUp: number = 0;
  PackageBal: number = 0;
  PackageThisWeek: number = 0;
  PackageLastWeek: number = 0;
  TotalPerHead: number = 0;
  WeekPerHead: number = 0;
}

export class AgentTree2ResultDto {
  IdAgent: number = 0;
  Agent: string = '';
  AgentLevel: number = 0;
  AgentExcluded: number = 0;
...
export class AgentPlayerTreeResponseDto {
  IdAgent: number = 0;        // Id del agente, inicializado en 0
  Agent: string = '';         // Nombre del agente, inicializado en cadena vacía
  IdPlayer: number = 0;       // Id del jugador, inicializado en 0
  Player: string = '';        // Nombre del jugador, inicializado en cadena vacía
  Password: string = '';      // Contraseña del jugador, inicializado en cadena vacía
  IdProfile: number = 0;      // Id del perfil, inicializado en 0
  IdProfileLimits: number = 0; // Límite del perfil, inicializado en 0
  NhlLine: string = '';       // Línea NHL, inicializado en cadena vacía

  // Métodos o lógica adicional se pueden agregar aquí si es necesario.
}

export class PlayerClassicCloneRequest {
  IdAgent: number = 0;           // Inicializado a 0
  Player: string = '';           // Inicializado a cadena vacía
  Password: string = '';         // Inicializado a cadena vacía
  Name: string = '';             // Inicializado a cadena vacía
  LastName: string = '';         // Inicializado a cadena vacía
  SelectedPlayerId: number = 0;  // Inicializado a 0
  // Puedes agregar más propiedades y inicializarlas aquí si es necesario
}

export class ProfileLimitsResultDto {
  IdProfileLimits: number = 0;
  ProfileName: string = '';
}
...
export class PlayerInfoRequestDto {
  RequestHeader: RequestHeaderDto = new RequestHeaderDto();
  IdPlayer: number = 0;
  IdSport: string = "";
}

export class PlayerProfileLimitDTO {
  IdPlayer: number = 0;
  IdProfileLimits: number = 0;
}


export class ProfileLimitsDto {
  IdProfileLimits: number = 0;
  IdGameType: number = 0;
  Description: string = '';
  IdSport: string = '';
...
export class SaveProfileDTO {
  ...
  GameTypes: GameTypesDTO[] = [];
}

export class GameTypesDTO {
  IdGameType: number = 0;
  Side: number = 0;
  Total: number = 0;
  MoneyLine: number = 0;
...
export class AddAgentDto {
  ...
  prmIdAgent: number = 0;
  makeUp: number = 0;
  commPercent: number = 0;
  ckCarryBalance: boolean = false;
  ckDistributor: boolean = false;
  idLineType: number = 0;
}

export class AgentSettingsResultDTO{
  Id: number = 0;
  IdAgent: number = 0;
  Theme: number = 0;
}

export class AgentSettingsRequestDto{
  IdAgent: number = 0;
  Theme: number = 0;
}

export class AgentExposureDetailDto{
  IdAgent: number = 0;
  IdGame: number = 0;
  WagerType: string = "";
  Play: number = 0;
...
export class AgentExposureDetailResultDto {
  IdPlayer: string = "";
  IdWager: number = 0;
  Ticket: number = 0;
  PlacedDate: string = '';
