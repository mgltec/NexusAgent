...
@Component({
  selector: 'app-CasinoGameDetails',
  templateUrl: './CasinoGameDetails.component.html',
  styleUrls: ['./CasinoGameDetails.component.css']
})
export class CasinoGameDetailsComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    this._DataService.UserSession.pipe(takeUntil(this._unsubscribeAll)).subscribe((ServiceUserInformation) => {
      ...
      this.dtOptions = {
        ...
        dom: 'Bfrtip',
        buttons: [
          {extend: 'copy', footer: true, className: 'pi pi-copy', text: '',title:'Casino Game Details'} ,
          {extend: 'print', footer: true, className: 'pi pi-print', text: '',title:'Casino Game Details'} ,
          {extend: 'excel', footer: true, className: 'pi pi-file-excel', text: '',title:'Casino Game Details',filename: 'Casino Game Details '+  this._currentUser.AgentSelected} ,
          {extend: 'pdf'},
          {extend: 'pdfHtml5'},
        ],
  ...
  GetReport(){
    ...
    let info: CasinoGameDetailsRequest = new CasinoGameDetailsRequest();
