...
/****************************DATATABLE OPTIONS*************************************** */
      this.dtOptions = {
        ...
        dom: 'Bfrtip',
        buttons: [
          {extend: 'copy', footer: true, className: 'pi pi-copy', text: '',title:'Daysheet Live'} ,
          {extend: 'print', footer: true, className: 'pi pi-print', text: '',title:'Daysheet Live'} ,
          {extend: 'excel', footer: true, className: 'pi pi-file-excel', text: '',title:'Daysheet Live',filename: 'Daysheet Live '+ this._currentUser.AgentSelected + ' ' + this._dateRange.Start} ,
          {extend: 'pdf'},
          {extend: 'pdfHtml5'},
        ],
