...
@Component({
  selector: 'app-CasinoDayHandle',
  templateUrl: './CasinoDayHandle.component.html',
  styleUrls: ['./CasinoDayHandle.component.scss']
})
export class CasinoDayHandleComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    this._DataService.UserSession.pipe(takeUntil(this._unsubscribeAll)).subscribe((ServiceUserInformation) => {
      ...
      this.dtOptions = {
        ...
        dom: 'Bfrtip',
        buttons: [
          {extend: 'copy', footer: true, className: 'pi pi-copy', text: '',title:'Casino Day Handle'} ,
          {extend: 'print', footer: true, className: 'pi pi-print', text: '',title:'Casino Day Handles'} ,
          {extend: 'excel', footer: true, className: 'pi pi-file-excel', text: '',title:'Casino Day Handle',filename: 'Casino Day Handle '+  this._currentUser.AgentSelected} ,
          {extend: 'pdf'},
          {extend: 'pdfHtml5'},
        ],
  ...
  GetReport(){
    ...
    let info: CasinoDayHandleRequest = new CasinoDayHandleRequest();
