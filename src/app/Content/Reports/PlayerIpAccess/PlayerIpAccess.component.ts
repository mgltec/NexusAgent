...
@Component({
  selector: 'app-PlayerIpAccess',
  templateUrl: './PlayerIpAccess.component.html',
  styleUrls: ['./PlayerIpAccess.component.css']
})
export class PlayerIpAccessComponent implements OnInit {
  ...
  ngOnInit() {
    this._DataService.UserSession.pipe(takeUntil(this._unsubscribeAll)).subscribe((ServiceUserInformation) => {
      ...
      this.dtOptions = {
        ...
        dom: 'Bfrtip',
        buttons: [
          {extend: 'copy', footer: true, className: 'pi pi-copy', text: '',title:'Player Ip Access'} ,
          {extend: 'print', footer: true, className: 'pi pi-print', text: '',title:'Player Ip Access'} ,
          {extend: 'excel', footer: true, className: 'pi pi-file-excel', text: '',title:'Player Ip Access',filename: 'Player Ip Access '+  this._currentUser.AgentSelected} ,
          {extend: 'pdf'},
          {extend: 'pdfHtml5'},
        ],
  ...
  GetReport() {
    ...
    let info: PlayerIPAccessRequest = new PlayerIPAccessRequest();
    ...
    this._reportService.GetPlayerIPAccess(info)
      .pipe(takeUntil(this._unsubscribeAll))
      .subscribe(data => {
