...
import { CashierModule } from './Content/Cashier/Cashier.module';
import { LandscapeNoticeModule } from './Content/ReusableComponents/LandscapeNotice/landscape-notice.module';
...
@NgModule({ declarations: [
        ...
        AddPlayerClassicComponent,
        AddAgentComponent,
        PlayerPaymentsComponent,
        FiguresComponent,
        WagersComponent,
        FinancialComponent,
        ...
        AgentsComponent,
        ManagementComponent,
        HoldPercentComponent,
        WebVsPhoneComponent,
        TopPlayerComponent,
        ManageProfileLimitesComponent,
    ],
